    ...
    <div className='flex flex-col items-center justify-center p-4 border border-gray-300 gap-4 rounded'>
      ...
      <div className='flex item-center justify-center w-60 cursor-pointer p-4'>
        {isImageLoading || isAudioLoading ? (
            ...
            <motion.button onClick={saveSong} whileTap={{scale: 0.75}} className="px-8 py-2 w-full rounded-md text-white bg-red-600 hover:shadow-lg">
                save song
            </motion.button>
        )}
      </div>
      <p className='text-xl font-semibold text-headingColor'>Artist Details</p>
      {/* for artist image file uploading */}
            <div className='bg-card backdrop-blur-md w-full h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer'>
      ...
      <div className='flex items-center rounded-md p-3 border border-gray-300 w-full'>
        ...
        <input type="text" placeholder='yourtwitter id' 
      ...
      <div className='flex item-center justify-center w-60 cursor-pointer p-4'>
        {isArtistUploading ? (
            ...
            <motion.button onClick={saveArtist} whileTap={{scale: 0.75}} className="px-8 py-2 w-full rounded-md text-white bg-red-600 hover:shadow-lg">
                save Artist
            </motion.button>
        )}
      </div>
      ...
      <div className='flex item-center justify-center w-60 cursor-pointer p-4'>
        {isAlbumUploading ? (
            ...
            <motion.button onClick={saveAlbum} whileTap={{scale: 0.75}} className="px-8 py-2 w-full rounded-md text-white bg-red-600 hover:shadow-lg">
                save Album
            </motion.button>
        )}
        </div>
...
export const FileUpLoader =({
    updateState, setProgress, isLoading, isImage, 
}) => {
    const upLoadFile =(e) =>{
        isLoading(true);
